...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = MyListAdapter(this, language, descriptionString)
        binding?.contentMain!!.listview?.adapter = adapter
        binding?.contentMain?.listview?.setOnItemClickListener() { adapterView, view, position, id ->
